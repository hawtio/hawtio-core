namespace Nav {
  ...
  export const verticalNavigationModule = angular
    .module('hawtio-vertical-navigation', ['ui.bootstrap'])
    .component('verticalNavigation', {
      ...
      //replace: true,
      templateUrl: 'navigation/vertical-navigation/vertical-navigation.html',
      transclude: true,
      controller: function ($window, $timeout, $injector, $location, $rootScope, $scope) {
        ...
        var updateMobileMenu = function (selected = undefined, secondaryItem = undefined) {
        ...
        var updateSecondaryCollapsedState = function (setCollapsed, collapsedItem = undefined) {
          var bodyContentElement = getBodyContentElement();
          if (collapsedItem) {
        ...
        var updateTertiaryCollapsedState = function (setCollapsed, collapsedItem = undefined) {
          var bodyContentElement = getBodyContentElement();
          if (collapsedItem) {
