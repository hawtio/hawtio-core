...
declare namespace Nav {
    ...
    class MainNavItem implements IMainNavItem {
        title: string;
        href: string;
        template: string;
        isValid: () => boolean;
...
declare namespace Nav {
    class MainNavService {
        ...
        private defaultTemplateUrl;
        private items;
        constructor($templateCache: ng.ITemplateCacheService);
        addItem(item: IMainNavItem): void;
        getValidItems(): MainNavItem[];
        getTemplateUrlByPath(path: string): string;
        setActiveItem(navigationItems: Nav.MainNavItem[], $location: ng.ILocationService): void;
        private activateFirstNavItem;
        private activateNavItemBasedOnPath;
    }
}
...
declare namespace Nav {
    class MainNavController {
        ...
        brandSrc: string;
        templateUrl: string;
        constructor(configManager: Core.ConfigManager, mainNavService: Nav.MainNavService, $location: ng.ILocationService);
        $onInit(): void;
        loadContent(): void;
    }
