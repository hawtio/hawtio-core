  ...
  export const userDropdownComponent: angular.IComponentOptions = {
    template: `
      <div class="pf-c-dropdown">
        <button id="userDropdownMenu" class="pf-c-dropdown__toggle pf-m-plain" ng-click="$ctrl.toggleMenu()"
          ng-blur="$ctrl.hideMenu()">
          {{$ctrl.fullName}} <img class="pf-c-avatar" src="img/img_avatar.svg" alt="Avatar Image">
        </button>
